...
class MatchControllerTest {
    ...
    void list_dateFilter_tiedPriorities_sortsDescendingPastAscendingUpcoming() {
        ...
        recent1.setPlayedAt(LocalDateTime.now().minusHours(3));
        MatchDto recent2 = matchWithTeams();
        recent2.setPlayedAt(LocalDateTime.now().minusHours(4));
        MatchDto upcoming1 = matchWithTeams();
        upcoming1.setPlayedAt(LocalDateTime.now().plusHours(2));
        MatchDto upcoming2 = matchWithTeams();
        upcoming2.setPlayedAt(LocalDateTime.now().plusHours(3));
        MatchDto otherDay = matchWithTeams();
        otherDay.setPlayedAt(LocalDateTime.now().minusDays(5));
